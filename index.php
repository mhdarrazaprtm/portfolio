...
<head>
    ...
    <title>Personal Portfolio | MAP</title>
    <style>
        [x-cloak] { 
            display: none 
        }
            ...
            <div x-cloak class="lg:min-h-screen relative overflow-x-hidden float-none clear-none transition-all duration-500" :class="width ? 'w-full lg:w-56%' : 'w-full lg:w-68%'">
                    ...
                    <section id="about" class="pt-37.5 lg:pt-0 pb-12.3 w-full block">
                        <div class="px-2.5 md:px-5 lg:px-8% mx-auto w-full">
                            <div class="w-full">
                                ...
                                <div class="flex flex-col justify-between mb-31">
                                        ...
                                        <table class="table-fixed w-full max-w-full text-left border-collapse">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-black dark:text-gray_6 font-normal tracking-1 py-2.3 pr-2.5">17</th>
                                                </tr>
                                                <tr>
                                                    <th class="text-gray_4 dark:text-gray_3 tracking-1 font-medium uppercase py-2.3 pr-2.5">Address</th>
                                                    <th class="text-black dark:text-gray_6 font-normal tracking-1 py-2.3 pr-2.5">Pekanbaru</th>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <!-- <div class="flex relative w-full group">
                                            <a href="" class="border-2 border-black dark:border-white border-opacity-20 dark:border-opacity-20 group-hover:border-opacity-100 group-hover:border-gold w-full flex flex-col items-center justify-center max-w-full h-54 text-gray_3 font-medium uppercase tracking-1 transition-all duration-300">
                                ...
                                <!-- Tabs Shortcode -->
                                <div x-data="{ tabs: 1 }" class="w-full overflow-hidden">
                                    <!-- Tab Header -->
                                    <div class="mb-9.5">
                                    ...
                                    <div>
                                            ...
                                            <div class="w-full">
                                                <ul>
                                                    ...
                                                    <li class="w-full">
                                                        <div class="box-item bg-gray_5 dark:bg-gray_11 border border-gray_6 dark:border-gray_12 w-full relative pt-10.2 px-10 pb-10.5">
                                                            <div class="flex flex-col md:flex-row mb-3.5">
                                                                <h5 class="text-lg uppercase font-normal leading-30 text-black dark:text-gray_6">PT Netviro</h5>
                                                    ...
                                                    <li class="w-full mb-5">
                                                        <div class="box-item bg-gray_5 dark:bg-gray_11 border border-gray_6 dark:border-gray_12 w-full relative pt-10.2 px-10 pb-10.5">
                                                            <div class="flex flex-col md:flex-row mb-3.5">
                                                                ...
                                                                <span class="block text-base leading-30 md:ml-5 text-gray_3">( 2019 — Today )</span>
                                                            </div>
                                                            <h3 class="text-black dark:text-gray_6 font-normal leading-tight text-2xl md:text-3xl">Vocational High School 2 Pekanbaru</h3>
                                                        </div>
                                                    </li>
                                                    <li class="w-full">
                                                        <div class="box-item bg-gray_5 dark:bg-gray_11 border border-gray_6 dark:border-gray_12 w-full relative pt-10.2 px-10 pb-10.5">
                                                            ...
                                                            <h3 class="text-black dark:text-gray_6 font-normal leading-tight text-2xl md:text-3xl">Junior High School 22 Pekanbaru</h3>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div x-cloak x-show="tabs == 3" class="block">
                                            ...
                                            <div class="mb-9 w-full">
                                                ...
                                                <div class="w-full mb-4.3">
                                                    <div class="w-full relative overflow-hidden">
                                                        <h3 class="text-gray_4 dark:text-gray_3 text-lg font-normal relative z-10 leading-40 mb-px">HTML5 & CSS3</h3>
                                            ...
                                            <!-- Description -->
                                            <div class="w-full">
                                                <p class="max-w-500">A freelance creative designer with a love for minimal design, clean typography and well-written code, located in Pekanbaru.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="px-2.5 md:px-5 lg:px-8% mx-auto w-full">
                            <div class="w-full">
                                ...
                                <form action="thanks.php" method="post">
                                    <div class="-ml-5 flex flex-wrap">
                                        ...
                                        <div class="w-full pl-5">
                                            <button type="submit" name="send" class="block w-full leading-26 py-5 px-5 text-lg uppercase text-center font-semibold hover:text-gold dark:hover:text-gold border-2 border-black dark:border-white border-opacity-20 dark:border-opacity-20 hover:border-opacity-100 dark:hover:border-opacity-100 hover:border-gold dark:hover:border-gold text-gray_4 dark:text-gray_6 duration-300">Send Message</button>
                                        </div>
                                    </div>
                                </form>
                                <!-- Contact Info -->
                                <div class="pt-23">
                                    ...
                                    <h3 class="text-black dark:text-gray_6 mb-14.5 md:max-w-300 leading-tight text-2xl md:text-3xl"><a href="wa.me/+6283173885776" class="hover:text-gold duration-300">(+62) 831-7388-5776</a></h3>
                ...
                <footer class="w-full float-left clear-both relative z-10 block">
                    ...
                    <div class="pt-15.5 pb-15.3">
                        <div class="px-2.5 md:px-5 lg:px-8% mx-auto w-full">
                            <p class="leading-30">Copyright © 2021. All rights reserved.<br>Designed & Developed by <a href="" class="relative text-gray_4 dark:text-gray_6 border-b border-black dark:border-white border-opacity-20 dark:border-opacity-20 hover:border-opacity-50 dark:hover:border-opacity-50 duration-300">Mhd. Arraza Pratama</a></p>
                        </div>
                    </div>
                </footer>
            </div>
                ...
                <div class="relative w-full lg:h-80.5 py-25 px-5 md:px-20% lg:px-16%">
                    <div class="py-9.3 px-10.1 relative w-full mb-7.5 z-10">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute left-0 top-0 right-0 bottom-0 bg-cover bg-center bg-no-repeat" style="background-image: url(assets/images/me.jpg);"></div>
                        </div>
                ...
                <div class="pt-12.3 transform transition-all duration-500" :class="menu ? 'delay-1500 opacity-100 translate-y-0' : 'delay-0 opacity-0 translate-y-12.3'">
                    <div class="mb-6.3">
                        <ul class="flex flex-row items-center flex-wrap">
                            ...
                            <li class="mr-2.5 mb-2.5">
                                <a href="https://www.instagram.com/tamathx/" class="bg-gray_7 dark:bg-white dark:bg-opacity-5 dark:hover:bg-opacity-10 hover:bg-gray_9 text-gray_4 flex items-center justify-center w-10 h-10 transition-all duration-300">
